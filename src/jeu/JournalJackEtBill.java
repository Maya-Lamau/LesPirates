...
public class JournalJackEtBill implements Affichage{
	...
	public void affichageDes(Pirate pirate, int valeur) {
		System.out.println(pirate.getNom() + ":" + "Voici la valeur de mon dé ! " + valeur +  " Allons vers la victoir, ce marin d'eau douce va nourir les poissons !");
	}
	public void affichageCase(Pirate pirate, int place) {
		System.out.println(pirate.getNom() + ":" + "Je suis maintenant à la case" + place + "La fin est proche mon ami !");
	}
	...
	public void affichageFinJeu() {
		System.out.println("Bravo à vous jeunes pirates, le jeu est terminé, nous pouvez vous reposez");
	}
